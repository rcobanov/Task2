  ...
  return (
    <>
      <h1>Välkommen till Feature Flicks!</h1>
        <Row>
        <p>Vårt mål är att skapa en bekväm och avkopplande miljö för dig att avnjuta en film i. Välkommen in i våra moderna salonger med den senaste ljud- och bildtekniken och låt dig slukas utav förstklassig filmupplevelse. På Feature Flicks så har vi också en kiosk där du kan köpa popcorn, läsk och andra snacks för att göra din bioupplevelse ännu mer komplett. Varmt välkommen att boka din bioupplevelse via vår bokningssida!
          </p>
        </Row>
